...
<html class="no-js" lang="ES">
	...
	<head>
        ...
        <link href="<s:url value="/css/jmesa.css"/>" rel="stylesheet" type="text/css">
	...
	<body>
		...
		<tiles:insertAttribute name="menu_superior"/>		
		
		<tiles:importAttribute name="acerca_de"/>  
		
		<s:if test="%{#attr['acerca_de'] == 'no'}">
